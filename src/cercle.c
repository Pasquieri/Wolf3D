...
static void	verif_mur(t_env *env, int x, int y, int color)
{
	...
	i = 4 * x + y * env->s_l2;
//	if (((env->img_str2[i] == (char)0) && (env->img_str2[i + 1] == (char)0) && (env->img_str2[i + 2] == (char)0)) || ((env->img_str2[i] == (char)200) && (env->img_str2[i + 1] == (char)220) && (env->img_str2[i + 2] == (char)254))) ==> pas de rond dans les murs
//	if (((env->img_str2[i] == (char)113) && (env->img_str2[i + 1] == (char)170) && (env->img_str2[i + 2] == (char)10)) || ((env->img_str2[i] == (char)200) && (env->img_str2[i + 1] == (char)220) && (env->img_str2[i + 2] == (char)254)))  ==> color_case if (...) == 1 : color pas les murs
